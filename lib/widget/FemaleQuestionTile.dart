...
class FemaleQuestionTile extends StatefulWidget {
  final int index;
  final formKey;
  ...
  @override
  State<FemaleQuestionTile> createState() => _FemaleQuestionTileState();
}

class _FemaleQuestionTileState extends State<FemaleQuestionTile> {
  bool isError = false;
  ...
  void initState() {
    ...
    enController.text = Provider.of<AppProvider>(context, listen: false)
        .selectedVaccine
        .vaccineQuestionsFemaleEn[widget.index];
    boController.text = Provider.of<AppProvider>(context, listen: false)
        .selectedVaccine
        .vaccineQuestionsFemaleBo[widget.index];
  }
