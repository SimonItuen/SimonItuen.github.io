...
class ContactUsUpdatePage extends StatefulWidget {
  const ContactUsUpdatePage({Key? key}) : super(key: key);

  @override
  _ContactUsUpdatePageState createState() => _ContactUsUpdatePageState();
}

class _ContactUsUpdatePageState extends State<ContactUsUpdatePage> {
                        ...
                        children: [
                          TextFormField(
                            ...
                            validator: (val) {
                              ...
                              isError = true;
                              if (val!.isEmpty) {
                                return '${locale!.contactUs} ${locale.cannotBeEmpty}';
                              } else {
                                isError = false;
                                return null;
                              }
